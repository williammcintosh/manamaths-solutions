...
\begin{column}{0.32\textwidth}\MMAnswer{1}{$2^4 = 16$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{125}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{6}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{81}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{Equal! $4^2 = 16$ and $2^4 = 16$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{32}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{27}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$3^4 = 81$ is larger}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$3^4$}\end{column}
\end{columns}
\end{frame}

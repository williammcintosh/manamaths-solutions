...
\begin{column}{0.32\textwidth}\MMAnswer{1}{Round $a$ to fewer s.f. E.g., $4.36 \times 10^{7}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{$4.36 \times 10^{7}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{$1.01 \times 10^{3} = 1010$ is larger by 11}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{$x = -3$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{$5.976 \times 10^{2}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{Avogadro's number}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{$4.5 \times 10^{-10}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$6.94 \times 10^{4}$ m/s}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$3.33 \times 10^{2}$}\end{column}
\end{columns}
\end{frame}

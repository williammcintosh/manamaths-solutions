...
\begin{column}{0.32\textwidth}\MMAnswer{1}{4$\,$200$\,$000}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{$1.2 \times 10^{-4}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{$6 \times 10^{7}$}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{$3 \times 10^{3}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{$3.6 \times 10^{-3}$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{12 km}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{$3.0 \times 10^{3}$ and $30 \times 10^{2}$ (same value)}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$9.81$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$0.0025 = 2.5 \times 10^{-3}$}\end{column}
\end{columns}
\end{frame}

...
\begin{column}{0.32\textwidth}\MMAnswer{2}{3 and 0 are integers; $-5.5$ and $\frac{1}{2}$ are not}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{2}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{9}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{4}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{$-2$, 0, 3}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{$6^{\circ}$C}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$-1$ is greater}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$-7$}\end{column}
\end{columns}
\end{frame}

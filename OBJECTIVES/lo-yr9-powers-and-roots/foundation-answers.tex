...
\begin{column}{0.32\textwidth}\MMAnswer{1}{$2^4$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{8}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{9}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{5}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{Rational (equals 2)}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{4}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{9}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$8 = 2^3$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$2^1$, $2^2$, $2^3$}\end{column}
\end{columns}
\end{frame}

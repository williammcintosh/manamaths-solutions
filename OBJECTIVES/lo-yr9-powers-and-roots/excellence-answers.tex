...
\begin{column}{0.32\textwidth}\MMAnswer{1}{$2^8 = 256$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{$\sqrt{10}$ is irrational (10 is not a perfect square)}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{$4^3 = 64 = 2^6$, $n = 6$}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{$32 = 2^5$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{$x = 12$ or $-12$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{$\sqrt{81} = 9$}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{$-3^2 = -9$, $(-3)^2 = 9$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$a = 7$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$(2^3)^4 = 2^{12} = 4096$}\end{column}
\end{columns}
\end{frame}

...
\WorksheetTitle{Push Tasks — Answers}
\vspace{-0.18em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{1}{Negative $\times$ negative $=$ positive, e.g., $-3 \times -4 = 12$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{2}{$-15 + 28 + 3 = 16$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{3}{Net $-3^{\circ}$C change; final $-1^{\circ}$C}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{4}{Distance $= |3 - (-2)| = 5$ units}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{5}{No, $-2 > -10$ is true ($-2$ is further right)}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{6}{Same here ($-8$) but differ for even exponents}\end{column}
\end{columns}
\vspace{0.45em}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.32\textwidth}\MMAnswer{7}{$-25$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{8}{$x = 10$}\end{column}
\begin{column}{0.32\textwidth}\MMAnswer{9}{$a - (-b) = a + b$}\end{column}
\end{columns}
\end{frame}
